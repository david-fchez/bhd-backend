...
func AndroidInterfaces() ([]Interface, error) {
...
func (i *Interface) AndroidAddrs() ([]net.Addr, error) {
	return i.addrs, nil
}

func (i *Interface) AndroidMulticastAddrs() ([]net.Addr, error) {
	return nil, fmt.Errorf("not implemented")
}

func AndroidInterfaceAddrs() ([]net.Addr, error) {
...
func AndroidInterfaceByIndex(index int) (*Interface, error) {
	interfaces, err := Interfaces()
	if err != nil {
		return nil, err
	}
